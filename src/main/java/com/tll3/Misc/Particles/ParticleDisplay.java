package com.tll3.Misc.Particles;

/*
 * tatsu here,
 * all credits for @CryptoMorin, as this was copied from his extension, Xseries
 * i don't own any of this code at all
 * */
 ...
 * }</pre>
 * This class is disposable by  methods.
 * It should not be used across multiple methods. I.e. it should not be
 * used even to spawn a simple particle after it was used by one of methods.
 * <p>
